package cn.z2huo.springcloud.netflix.eureka.client.consumer;
...
public class EurekaClientConsumerApplication {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext context = SpringApplication.run(EurekaClientConsumerApplication.class, args);
